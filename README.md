...
🐛 **Report Bugs**: [GitHub Issues](https://github.com/yourusername/qr_gen/issues)
💡 **Request Features**: [GitHub Discussions](https://github.com/yourusername/qr_gen/discussions)
